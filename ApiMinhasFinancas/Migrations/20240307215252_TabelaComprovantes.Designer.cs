...
namespace ApiMinhasFinancas.Migrations
{
    ...
    [Migration("20240307215252_TabelaComprovantes")]
    partial class TabelaComprovantes
    {
            ...
            modelBuilder.Entity("ApiMinhasFinancas.Models.FormasPagamento", b =>
                {
                    ...
                    b.ToTable("FormasPgto");
                });

            modelBuilder.Entity("ApiMinhasFinancas.Models.TipoConta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ApiMinhasFinancas.Models.Documentos", b =>
                {
                    ...
                    b.HasOne("ApiMinhasFinancas.Models.TipoConta", "Fk_Tipoconta")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
